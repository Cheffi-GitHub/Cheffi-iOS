...
enum RestRouter {
    ...
    case profileReviews(id: String, cursor: Int?, size: Int)
    case profilePurchase(id: String, cursor: Int?, size: Int)
    case profileBookmarks(id: String, cursor: Int?, size: Int)
